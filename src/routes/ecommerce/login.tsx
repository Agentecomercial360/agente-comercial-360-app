        ...
        <section className="flex items-center justify-center px-6 py-12 sm:px-10">
          <div className="w-full max-w-md">
            ...
            <div className="mb-10 flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <p className="text-lg font-bold text-foreground">
                  E-commerce <span className="text-primary font-medium italic">Intelligence</span>
                </p>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Acesse o <span className="text-primary">E-commerce Intelligence</span>
            </h1>
            <p className="mt-3 text-[15px] leading-relaxed text-muted-foreground">
              Centralize suas contas, acompanhe produtos, estoque, Ads e prioridades da sua operação em um único lugar.
            </p>
            ...
            <div className="mt-8 rounded-2xl border border-border bg-card p-6 shadow-[0_10px_40px_-12px_oklch(0.28_0.14_262_/_0.18)] sm:p-7">
              <form onSubmit={onSubmit} className="space-y-5">
                ...
                >
                  {loading ? "Entrando..." : "Entrar no painel E-commerce"}
                </button>

                <p className="flex items-center justify-center gap-1.5 pt-1 text-xs text-muted-foreground">
                  <ShieldCheck className="h-3.5 w-3.5 text-primary/70" />
                  Acesso restrito para operações cadastradas no módulo E-commerce.
                </p>
              </form>
            </div>
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16 text-white">
            ...
            <div className="max-w-md">
              <h2 className="font-display text-4xl font-bold leading-[1.1] tracking-tight xl:text-[2.75rem]">
                Operação E-commerce inteligente
              </h2>
              <p className="mt-5 text-[15px] leading-relaxed text-white/75">
                Centralize múltiplas contas do Mercado Livre, acompanhe produtos travados, estoque, Ads e decisões com apoio de IA.
              </p>

              <ul className="mt-10 space-y-4">
                {[
                  { icon: LayoutGrid, label: "Multi-contas Mercado Livre" },
                  { icon: PackageSearch, label: "Produto unificado e estoque centralizado" },
                  { icon: AlertCircle, label: "Produtos travados e prioridades de ação" },
                  { icon: Wand2, label: "IA consultora para otimização de operação" },
                ].map(({ icon: Icon, label }) => (
            ...
            <div className="flex items-center gap-3 text-[11px] text-white/55">
              ...
              <span className="uppercase tracking-[0.18em]">
                PLATAFORMA PARA OPERAÇÕES DE E-COMMERCE DE ALTA PERFORMANCE
              </span>
            </div>
          </div>
        </aside>
