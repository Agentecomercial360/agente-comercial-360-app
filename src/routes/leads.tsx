    ...
    <DashboardLayout>
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 p-6 shadow-sm">
          ...
          <div className="absolute -bottom-20 -left-10 h-56 w-56 rounded-full bg-rose-500/20 blur-3xl" />
            ...
            <div className="max-w-2xl">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-blue-100 ring-1 ring-white/20">
                  <Sparkles className="h-3 w-3" /> IA comercial
                </span>
              </div>
              <h1 className="mt-3 text-3xl font-bold tracking-tight text-white">Leads</h1>
            ...
            <div className="w-full max-w-sm rounded-xl border border-white/15 bg-white/10 p-4 backdrop-blur-sm md:w-80">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-medium text-blue-200/70">
                  {loadingLeads ? "Sincronizando…" : "Atualizado agora"}
                </span>
              </div>
              <div className="mt-3 grid grid-cols-3 gap-3">
                <div>
                  <p className="text-[10px] font-medium uppercase tracking-wide text-blue-200/70">Total</p>
                  <p className="mt-1 text-xl font-bold text-white tabular-nums">{totalLeads}</p>
                </div>
                <div>
                  <p className="text-[10px] font-medium uppercase tracking-wide text-blue-200/70">Quentes</p>
                  <p className="mt-1 text-xl font-bold text-white tabular-nums">{hotLeads}</p>
                </div>
                <div>
                  <p className="text-[10px] font-medium uppercase tracking-wide text-blue-200/70">Negociação</p>
                  <p className="mt-1 text-xl font-bold text-white tabular-nums">{negotiatingLeads}</p>
                </div>
              </div>
              <p className="mt-3 text-[11px] leading-relaxed text-blue-100/80">
                Visão consolidada das oportunidades comerciais em andamento.
              </p>
            </div>
          </div>
        </div>
